...
--   - systems/self-referential-category-theoretic-structures/docs/UMBRAL_SYNTHESIS.md (dependency)
...
--   - systems/self-referential-category-theoretic-structures/docs/UMBRAL_SYNTHESIS.md (reference)
